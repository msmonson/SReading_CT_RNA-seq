...
mkdir ./04-trimmed_fastq/lane3/MM

module load java
module load trimmomatic/0.39

cd ./02-raw_fastq/lane3/MM
...
for i in *R1_001.fastq ; 
	...
	/90daydata/fsep_004/msmonson/04-trimmed_fastq/lane3/MM/${sample}_R1_paired.fastq \
	/90daydata/fsep_004/msmonson/04-trimmed_fastq/lane3/MM/${sample}_R1_unpaired.fastq \
	/90daydata/fsep_004/msmonson/04-trimmed_fastq/lane3/MM/${sample}_R2_paired.fastq \
	/90daydata/fsep_004/msmonson/04-trimmed_fastq/lane3/MM/${sample}_R2_unpaired.fastq \
